...
namespace WebShop.Controllers
{
    public class ItemController : Controller
    {
        public IActionResult Index(int id)
        {
            ...
            model.Categories = CategoryManager.GetAll().Select(c => c.ToCModel()).ToList();
            model.Items = ItemManager.GetByCategory(id).Select(c => c.ToIModel()).ToList();
        ...
        public IActionResult List()
        {
            ...
            var items = ItemManager.GetAll().Select(c => c.ToIModel()).ToList();
            return View(items);
        }
